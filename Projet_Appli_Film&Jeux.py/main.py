from gestionnaire_films_jeux import GestionnaireFilmsJeux
from statistiques import Statistiques

def afficher_menu():
    print("===== Menu =====")
    print("1. Ajouter un nouveau film ou jeu")
    print("2. Modifier les informations d'un film ou jeu")
...
def main():
    gestionnaire = GestionnaireFilmsJeux()
